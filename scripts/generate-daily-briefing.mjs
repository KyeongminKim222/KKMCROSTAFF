...
const commonResearchRules = 실행일은 ${date} KST다. 실행 시점 기준 최근 24시간의 공개 정보를 primary 후보로 삼아라. 각 후보는 서로 다른 단일 사건이어야 하며, 같은 사건의 반복 보도는 대표 원문 하나로 통합하라. URL은 실제 검색으로 확인한 개별 기사 또는 개별 공식 발표의 직접 링크만 사용하라. 검색결과·기관 섹션·게시판 목록 URL은 후보로 제시하지 마라. 게시 일시는 KST 기준으로 적고 확인할 수 없으면 '게시 시각 미확인'이라고 명시하라. 확인된 사실과 CRO 관점의 분석을 구분하고, 수치·날짜·기관명·기업명을 검증하라. 자본·유동성·신용·시장·운영·사이버·법무/준법·평판·전략 리스크 영향을 평가하라. 신뢰할 만한 후보가 부족하면 숫자를 채우지 말고 조사 메모에 이유를 적어라. primary 후보가 부족하면 맥락 이해에 직접 필요한 최근 7일 이내 유관·배경 자료를 추가 조사하되 반드시 related라고 표시하고 날짜를 명확히 적어라. 전일 제목은 중대한 신규 사실이 있을 때만 다시 후보에 포함하라: ${JSON.stringify(previousTitles)} 각 후보에 제목, 매체·기관, 게시 일시, 직접 URL, 확인된 사실, 우리금융 CRO 중요성, 리스크 유형, 긴급도, 근거 신뢰도와 확인할 질문을 포함하라. 특정 매체 한두 곳에 후보가 몰리지 않도록 최대한 다양한 언론사에서 고르게 검색하라. 같은 매체의 기사가 전체 후보의 절반을 넘지 않게 하라. 모든 한국어 서술은 임원 보고서에 맞는 정중한 합니다체로 작성하라. 문장을 '한다·이다·있다·된다·필요하다'로 끝내지 말고 '합니다·입니다·있습니다·됩니다·필요합니다'로 끝내라. 반드시 웹 검색을 수행하고, 모든 후보 옆에 실제 검색 출처를 인라인 인용으로 붙여라. 이 조사 단계에서는 JSON을 만들지 말고 읽기 쉬운 한국어 조사 메모로 답하라.;
...
한국 주요 통신사·경제지·금융 전문매체 및 네이버뉴스의 일반 언론기사를 조사하라. 금리·환율·유동성·부동산 PF·가계/기업 신용·자본규제·소비자보호·사이버·운영리스크와 금융회사 사건을 폭넓게 점검하라. 정부기관 보도자료가 아니라 기자가 작성한 기사 원문을 후보로 최대 16건 제시하라. 같은 정책도 시장·금융회사 파급효과를 분석한 언론기사를 우선하라.,
koreanMediaDomains,
6
);
...
한국 주요 통신사·경제지·금융 전문매체 및 네이버뉴스에서 우리금융그룹과 계열사에 관한 일반 언론기사를 조사하라. 우리금융지주·우리은행·우리카드·우리금융캐피탈·우리종합금융·우리자산운용·우리투자증권·동양생명·ABL생명 관련 보도를 최우선으로, 빠짐없이 찾아라. 이 조사 단계는 오직 우리금융그룹 자체 뉴스에만 집중한다. 우리은행의 해외지점 및 해외 현지법인(캄보디아, 인도네시아, 우리아메리카은행 등) 관련 보도도 적극적으로 조사하라. 우리은행 해외법인 관련 직접 보도를 찾기 어려운 경우, 캄보디아·인도네시아·우리아메리카은행이 영업하는 지역의 금융권 일반 동향(금리, 환율, 은행 건전성, 규제 변화 등) 기사도 후보로 조사하라. 기업 홈페이지·공시 링크가 아니라 기자가 작성한 기사 원문을 후보로 최대 14건 제시하라.,
koreanMediaDomains,
5
);
...
한국 주요 통신사·경제지·금융 전문매체 및 네이버뉴스에서 KB금융·신한금융·하나금융·NH농협금융·IBK기업은행 및 주요 증권·보험·카드사에 관한 일반 언론기사를 조사하라. 자본, 건전성, 인수합병, 제재, 사고, 실적과 리스크 변화를 중심으로 점검하라. 우리금융그룹 관련 기사는 이 단계에서 조사하지 않는다. 기업 홈페이지·공시 링크가 아니라 기자가 작성한 기사 원문을 후보로 최대 10건 제시하라.,
koreanMediaDomains,
4
);
...
Reuters, Bloomberg, FT, WSJ, CNBC, AP, Nikkei 등 신뢰도 높은 글로벌 언론에서 우리금융그룹으로 전이될 수 있는 일반 금융기사를 조사하라. 금리·달러·채권·주식·원자재·지정학·해외 상업용 부동산·은행 건전성·사이버·제재·AML 변화를 점검하라. 기관 발표문 자체보다 기자가 취재·작성한 기사 원문을 후보로 최대 12건 제시하라.,
globalMediaDomains,
4
);
...
언론 조사에서 다룰 가능성이 높은 한국·글로벌 금융시장, 규제·정책, 우리금융 및 경쟁사 이슈를 공식 1차 자료로 검증하라. 금융위원회·금융감독원·한국은행·기획재정부·거래소·DART·우리금융 공식자료와 BIS·FSB·IMF·Fed·ECB 자료를 확인하라. 공식자료는 사실·수치·날짜 검증용이다. 최종 브리핑 전체를 공식자료로 채우지 않도록 CRO 관련성이 가장 높은 자료만 최대 10건 제시하라.,
officialDomains,
3
);
...
우리금융그룹과 계열사 직접 영향은 범주와 관계없이 상향
...
critical, daily_news, subsidiary_news, additional_news 네 카테고리를 통틀어 같은 URL이나 같은 게시물 번호(seq, id 등)를 가진 기사를 두 번 이상 선택하지 마라.

URL은 각 조사팀의 source_urls에 있는 값을 글자 하나도 바꾸지 않고 그대로 복사한다.

검색결과, 언론사·기관의 뉴스 섹션 첫 화면, 게시판 목록 주소는 기사로 선정하지 않는다.
...
모든 문장은 예외 없이 정중한 합니다체를 사용한다.

executive_judgment_bullets는 3~4개로 작성한다. 각 항목은 자연스럽게 이어지는 2문장의 완결된 문장으로 서술하며, "확인된 변화는", "핵심 수치는" 같은 정형화된 라벨을 문장 맨 앞에 반복하지 않는다.

각 기사 summary는 3~5문장으로 작성한다. 첫 문장에서 매체명과 게시일을 밝히고, 핵심 수치·당사자·발생 경위·현재 상태를 구체적으로 설명한다.

why_woori_cro는 23문장으로 작성하며, 우리은행 또는 관련 계열사에 미치는 영향과 3090일 의사결정 포인트를 구체적으로 연결한다.

watchpoints는 기사마다 2~3개, 실제로 확인할 지표나 질문으로 작성한다.
...
const MINIMUM_ARTICLES_FALLBACK = 3;
